...
/**
 * This <i>Metal Look and Feel</i> theme is used to give our application a
 * unique look. Use <code>MediknightTheme.install()</code> to install this
 * theme. The following features are redefined:
 * <ul>
...
public class MediknightTheme extends DefaultMetalTheme {
     ...
     * Installs the theme.
     */
    public static void install(Properties prop) {
    try {
        primary1 = new ColorUIResource(
                    Integer.parseInt(prop.getProperty("primary1.r")),
                    Integer.parseInt(prop.getProperty("primary1.g")),
                    Integer.parseInt(prop.getProperty("primary1.b")));


        primary2 = new ColorUIResource(
                    Integer.parseInt(prop.getProperty("primary2.r")),
                    Integer.parseInt(prop.getProperty("primary2.g")),
                    Integer.parseInt(prop.getProperty("primary2.b")));

        primary3 = new ColorUIResource(
                    Integer.parseInt(prop.getProperty("primary3.r")),
                    Integer.parseInt(prop.getProperty("primary3.g")),
                    Integer.parseInt(prop.getProperty("primary3.b")));


        secondary1 = new ColorUIResource(
                    Integer.parseInt(prop.getProperty("secondary1.r")),
                    Integer.parseInt(prop.getProperty("secondary1.g")),
                    Integer.parseInt(prop.getProperty("secondary1.b")));

        secondary2 = new ColorUIResource(
                    Integer.parseInt(prop.getProperty("secondary2.r")),
                    Integer.parseInt(prop.getProperty("secondary2.g")),
                    Integer.parseInt(prop.getProperty("secondary2.b")));

        secondary3 = new ColorUIResource(
                    Integer.parseInt(prop.getProperty("secondary3.r")),
                    Integer.parseInt(prop.getProperty("secondary3.g")),
 ...
 /*   private final ColorUIResource primary1 = new ColorUIResource(102, 153, 153);
    ...
    private static final ColorUIResource secondary2 = new ColorUIResource(153, 153, 158);
    private static final ColorUIResource secondary3 = new ColorUIResource(204, 204, 208);
*/
    ...
    /* green
        primary1 = new ColorUIResource(51, 102, 51);
        primary2 = new ColorUIResource(102, 153, 102);
        primary3 = new ColorUIResource(153, 204, 153);

        secondary1 = new ColorUIResource(102, 102, 102);
        secondary2 = new ColorUIResource(153, 158, 153);
        secondary3 = new ColorUIResource(204, 208, 204);
    */
    ...
    // Required to make the VM aware of all installed fonts, especially Tahoma, see below
    static {
    ...
    public void addCustomEntriesToTable(UIDefaults table) {
        ...
        table.put("ScrollBarUI", "de.bo.mediknight.MediknightScrollBarUI");
        table.put("OptionPaneUI", "de.bo.mediknight.MediknightOptionPaneUI");
        ...
        table.put("ComboBoxUI", "de.bo.mediknight.MediknightComboBoxUI");
        table.put("ComboBox.font", table.getFont("TextField.font"));
        table.put("ComboBox.selectionBackground", primary3);
        table.put("ButtonUI", "de.bo.mediknight.MediknightButtonUI");
        table.put("Button.defaultBackground", primary3);
        table.put("ToggleButtonUI", "de.bo.mediknight.MediknightToggleButtonUI");
        table.put("ToggleButton.selectedBackground", primary3);
        table.put("MenuBarUI", "de.bo.mediknight.MediknightMenuBarUI");
        table.put("MenuUI", "de.bo.mediknight.MediknightMenuUI");
        table.put("List.font", table.getFont("TextField.font"));
        table.put("SplitPaneUI", "de.bo.mediknight.MediknightSplitPaneUI");
