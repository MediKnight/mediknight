...
public class ErrorDisplay {
	...
	pane.add( new de.bo.mediknight.widgets.JTextArea( displayMessage + "\n" + throwable.getMessage() ), BorderLayout.CENTER );
	...
	if( traceFrame == null ) {
	    ...
	    final de.bo.mediknight.widgets.JTextArea details = new de.bo.mediknight.widgets.JTextArea( trace.toString() );
