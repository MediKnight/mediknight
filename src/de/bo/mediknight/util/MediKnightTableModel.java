...
public class MediKnightTableModel extends AbstractTableModel {
    ...
    /**
     * Translate a change in the JTable to a change of the MediKnightTableModel
     * and store this change in the database.
     */
    public void setValueAt( final Object value, final int row, final int col) {
        if( value != null && data != null && row < data.size() ) {
            if( col >= 0 && col < 2 ) {
                ...
                switch( col ){
                    case 0 : // TODO Date Datentyp im Programm gem. Java-Standards verwenden und nicht mit dem SQL-DT an Stellen arbeiten, die deisen niht erfordern!
