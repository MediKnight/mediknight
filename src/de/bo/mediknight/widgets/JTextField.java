...
/**
 * This subclass of <code>JTextField</code> supports an easy to use
...
public class JTextField extends javax.swing.JTextField implements MutableTextComponent, DocumentListener {
     ...
     *
     * @param initialText the initial text of the <code>JTextField</code>
     *
     * @since 1.0
     */
    ...
    /**
     * update the <code>JTextField</code>'s border, if it is an instance of
     ...
     *
     * @param originalText the new original text of the <code>JTextField</code>.
     *
     * @since 1.1
     */
    ...
    /**
     * Set the text of this <code>JTextField</code>. Also sets the original
     * text if necessary (i.e., if it is <code>null</code>)
     *
     * @param newText the new text of the <code>JTextField</code>
     *
     * @since 1.1
     */
    ...
    /**
     * add a text listener to this <code>JTextField</code>, using the
    ...
    /**
     * remove a text listener from this <code>JTextField</code>, using the
     * <code>TextListener</code> plugin.
     *
     ...
     * <code>MutableChangeEvents</code> is allowed.
     *
     * @since 1.5
     */
