...
public class CopyOfLookAndFeelCustomizer {
	...
	final HashMap< String, Object > defaultPropertiesForComponent = computeDefaultProperties( component, new HashMap< String, Object >(),
		defaultProperties, Arrays.asList( new String[] { "*", propertyKey } ) );
    ...
    @SuppressWarnings( "unchecked" )
    protected void
	    customizeUITree( final JComponent root, final HashMap< String, Object > defaultProperties, final HashMap< String, Object > specialProperties ) {
	...
	for( int index = 0; index < componentCount; index++ ) {
	    ...
	    final HashMap< String, Object > childProperties = specialProperties == null ? null : (HashMap< String, Object >) specialProperties.get( child
		    .getName() );
