...
public class ColorPanel extends JPanel {
    ...
    public ColorPanel(Properties prop) {
        this.prop = prop;
        jbInit();
        boInit();
    }
    ...
    private void boInit() {
        ...
        legend.setText( "<html><b>Legende:</b><br>" +
                        "Farbe 1: Rollbalken<br>" +
                        "Farbe 2: Haupthintergrundfarbe<br>" +
                        "Farbe 3: Aktivierte Schaltfläche<br>" +
                        "Farbe 4: Rand jeder Komponente<br>" +
                        "Farbe 5: Farbe beim Drücken einer Schaltfläche<br>" +
                        "Farbe 6: Farbe einer inaktiven Schaltfläche und zweite Hintergrundfarbe<br><p>" +
                        "<i><font size=\"2\">Um die veränderten Farbwerte zu aktivieren, muß die Anwendung neu gestartet werden!</i></p></html>");
    ...
    private Color changeColor(Color c, int i) {
        Color newColor = JColorChooser.showDialog(
            this, "Farbe " + i + " auswählen", c);
    ...
    public void setPresenter(ColorPresenter presenter) {
