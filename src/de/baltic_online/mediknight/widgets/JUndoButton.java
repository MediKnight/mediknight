...
public class JUndoButton extends de.baltic_online.mediknight.widgets.JButton implements UndoHandler {
	...
	if( widget != null ) {
	    if( !(widget instanceof de.baltic_online.mediknight.widgets.JRadioButton) ) {
	...
	if( mutable instanceof de.baltic_online.mediknight.widgets.JRadioButton ) {
