...
public class MediknightTheme extends DefaultMetalTheme {
	...
	table.put( "ScrollBarUI", "de.baltic_online.mediknight.MediknightScrollBarUI" );
	table.put( "OptionPaneUI", "de.baltic_online.mediknight.MediknightOptionPaneUI" );
	...
	table.put( "ComboBoxUI", "de.baltic_online.mediknight.MediknightComboBoxUI" );
	table.put( "ComboBox.font", table.getFont( "TextField.font" ) );
	table.put( "ComboBox.selectionBackground", primary3 );
	table.put( "ButtonUI", "de.baltic_online.mediknight.MediknightButtonUI" );
	table.put( "Button.defaultBackground", primary3 );
	table.put( "ToggleButtonUI", "de.baltic_online.mediknight.MediknightToggleButtonUI" );
	table.put( "ToggleButton.selectedBackground", primary3 );
	table.put( "MenuBarUI", "de.baltic_online.mediknight.MediknightMenuBarUI" );
	table.put( "MenuUI", "de.baltic_online.mediknight.MediknightMenuUI" );
	table.put( "List.font", table.getFont( "TextField.font" ) );
	table.put( "SplitPaneUI", "de.baltic_online.mediknight.MediknightSplitPaneUI" );
