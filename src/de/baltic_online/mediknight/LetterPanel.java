...
public class LetterPanel extends JPanel implements ChangeListener {
	...
	this.add( adressLbl, new GridBagConstraints( 0, 1, 3, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH, new Insets( 5, 0, 0, 0 ), 0,
		0 ) );
	...
	this.add( dummyPanel, new GridBagConstraints( 1, 2, 2, 1, 0.4, 0.1, GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH, new Insets( 0, 0, 0, 0 ), 0,
		0 ) );
	this.add( dateComponentsPanel, new GridBagConstraints( 1, 4, 2, 1, 0.4, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
	...
	this.add( diagnosticSP, new GridBagConstraints( 0, 6, 3, 1, 1.0, 0.6, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets( 0, 0, 0, 0 ), 0,
		0 ) );
	this.add( greetingsLbl, new GridBagConstraints( 0, 7, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets( 5, 0, 0, 0 ), 2, 0 ) );
	...
	this.add( jPanel2, new GridBagConstraints( 0, 9, 4, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets( 10, 0, 0, 0 ), 0,
		0 ) );
