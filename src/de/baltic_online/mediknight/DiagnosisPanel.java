...
import de.baltic_online.mediknight.util.DateChooserTableCellEditor;
import de.baltic_online.mediknight.util.DateTableCellRenderer;
import de.baltic_online.mediknight.util.ErrorDisplay;
import de.baltic_online.mediknight.util.MediKnightTableModel;
...
public class DiagnosisPanel extends de.baltic_online.mediknight.widgets.JPanel implements ChangeListener, FocusListener, ActionListener {
	...
	this.add( jPanel5, new GridBagConstraints( 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets( 10, 0, 0, 0 ),
		0, 0 ) );
