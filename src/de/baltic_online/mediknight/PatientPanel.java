...
import de.baltic_online.mediknight.widgets.JComboBox;
import de.baltic_online.mediknight.widgets.JPanel;
import de.baltic_online.mediknight.widgets.JRadioButton;
import de.baltic_online.mediknight.widgets.JScrollPane;
import de.baltic_online.mediknight.widgets.JTextArea;
import de.baltic_online.mediknight.widgets.JTextField;
import de.baltic_online.mediknight.widgets.JUndoButton;
...
public class PatientPanel extends JPanel implements ChangeListener {
	...
	deleteBtn.addActionListener( new ActionListener() {
		...
		final int r = JOptionPane.showConfirmDialog( null, "Patient " + presenter.getModel().getPatient() + " löschen ?", "Patient löschen",
    ...
    public void getContent( final Patient patient ) {
	...
	this.add( panel1, new GridBagConstraints( 0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets( 5, 0, 0, 0 ), 0, 0 ) );
	panel1.add( kkLabel, null );
	panel1.add( finanzamtPrivatBtn, null );
	panel1.add( privatBtn, null );
	this.add( panel3, new GridBagConstraints( 0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets( 0, 0, 0, 0 ), 0, 0 ) );
	panel3.add( jScrollPane1, null );
	jScrollPane1.getViewport().add( achtungTA, null );
	this.add( panel2, new GridBagConstraints( 0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets( 5, 0, 0, 0 ), 0, 0 ) );
	panel2.add( achtungLbl, null );
	this.add( panel4, new GridBagConstraints( 0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets( 5, 0, 0, 0 ), 0, 0 ) );
    ...
    public void setPresenter( final PatientPresenter presenter ) {
	...
	final Patient patient = presenter.getModel().getPatient();
