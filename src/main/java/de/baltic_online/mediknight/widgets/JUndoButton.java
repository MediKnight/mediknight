...
public class JUndoButton extends main.java.de.baltic_online.mediknight.widgets.JButton implements UndoHandler {
	...
	if( widget != null ) {
	    if( !(widget instanceof main.java.de.baltic_online.mediknight.widgets.JRadioButton) ) {
	...
	if( mutable instanceof main.java.de.baltic_online.mediknight.widgets.JRadioButton ) {
